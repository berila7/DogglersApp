...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView firstDogImage;
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView age, @NonNull ImageView firstDogImage, @NonNull TextView hobbies,
      @NonNull TextView name) {
    this.rootView = rootView;
    this.age = age;
    this.firstDogImage = firstDogImage;
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.firstDogImage;
      ImageView firstDogImage = ViewBindings.findChildViewById(rootView, id);
      if (firstDogImage == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, age, firstDogImage,
          hobbies, name);
    }
