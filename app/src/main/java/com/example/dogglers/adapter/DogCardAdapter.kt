...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View): RecyclerView.ViewHolder(view) {
        val image: ImageView = view.findViewById(R.id.firstDogImage)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        return DogCardViewHolder (when(layout) {
            Layout.GRID -> adapterLayout.inflate(R.layout.grid_list_item, parent, false)
            Layout.HORIZONTAL -> adapterLayout.inflate(R.layout.vertical_horizontal_list_item, parent, false)
            else -> adapterLayout.inflate(R.layout.vertical_horizontal_list_item, parent, false)
        })
